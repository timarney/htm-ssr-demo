// This part was added for demo purposes
// No access to the document for SSR so:
import jsdom from "jsdom";
const { JSDOM } = jsdom;
const { document } = new JSDOM(`...`).window;

// I stole this from a Github repo 
// I keeped tucked up under

// The following is from https://github.com/developit/htm
/**
...
function walk(n) {
  ...
  for (let i = 0; i < n.attributes.length; i++) {
    ...
    if (name == "c@") {
      ...
      str += `${sub}"${name.replace(/:::(\w)/g, (s, i) => i.toUpperCase())}":${
